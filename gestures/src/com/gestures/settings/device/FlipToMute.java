...
public class FlipToMute implements UpdatedStateNotifier {
    private static final String TAG = "Actions-FlipToMute";
    ...
    public FlipToMute(ActionsSettings cmActionsSettings, Context context,
    ...
    public void updateState() {
        if (mActionsSettings.isFlipToMuteEnabled() && !mIsEnabled) {
            Log.d(TAG, "Enabling");
            ...
            mIsEnabled = true;
        } else if (!mActionsSettings.isFlipToMuteEnabled() && mIsEnabled) {
            Log.d(TAG, "Disabling");
