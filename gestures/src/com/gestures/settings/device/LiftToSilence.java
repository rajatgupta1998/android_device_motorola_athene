...
public class LiftToSilence extends PhoneStateListener implements SensorEventListener, UpdatedStateNotifier {
    private static final String TAG = "Actions-LiftToSilence";
    ...
    public LiftToSilence(ActionsSettings cmActionsSettings, Context context,
    ...
    public void updateState() {
        if (mActionsSettings.isLiftToSilenceEnabled()) {
