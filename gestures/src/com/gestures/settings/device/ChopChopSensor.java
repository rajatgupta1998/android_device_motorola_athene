...
public class ChopChopSensor implements SensorEventListener, UpdatedStateNotifier {
    private static final String TAG = "Actions-ChopChopSensor";
    ...
    public ChopChopSensor(ActionsSettings cmActionsSettings, SensorHelper sensorHelper) {
    ...
    public synchronized void updateState() {
        if (mActionsSettings.isChopChopGestureEnabled() && !mIsEnabled) {
            Log.d(TAG, "Enabling");
            mSensorHelper.registerListener(mSensor, this);
            mSensorHelper.registerListener(mProx, mProxListener);
            mIsEnabled = true;
        } else if (! mActionsSettings.isChopChopGestureEnabled() && mIsEnabled) {
            Log.d(TAG, "Disabling");
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        mActionsSettings.chopChopAction();
    }
