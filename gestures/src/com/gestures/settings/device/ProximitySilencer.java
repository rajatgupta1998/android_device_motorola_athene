...
public class ProximitySilencer extends PhoneStateListener implements SensorEventListener, UpdatedStateNotifier {
    private static final String TAG = "Actions-ProximitySilencer";
    ...
    public ProximitySilencer(ActionsSettings cmActionsSettings, Context context,
    ...
    public void updateState() {
        if (mActionsSettings.isIrSilencerEnabled()) {
