...
public class ActionsService extends IntentService implements ScreenStateNotifier,
    ...
    public ActionsService(Context context) {
        ...
        mWakeLock = mPowerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "ActionsWakeLock");
        updateState();
    }
