...
public class GlanceSensor implements ScreenStateNotifier {
    private static final String TAG = "Actions-GlanceSensor";
    ...
    public GlanceSensor(ActionsSettings cmActionsSettings, SensorHelper sensorHelper,
                SensorAction action) {
    ...
    public void screenTurnedOff() {
        if (mActionsSettings.isPickUpEnabled() && !mEnabled) {
            Log.d(TAG, "Enabling");
