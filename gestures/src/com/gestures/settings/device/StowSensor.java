...
public class StowSensor implements ScreenStateNotifier, SensorEventListener {
    private static final String TAG = "Actions-StowSensor";
    ...
    public StowSensor(ActionsSettings cmActionsSettings, SensorHelper sensorHelper,
                SensorAction action) {
    ...
    public void screenTurnedOff() {
        if (!mActionsSettings.isIrWakeupEnabled() &&
            mActionsSettings.isPickUpEnabled() && !mEnabled) {
            Log.d(TAG, "Enabling");
