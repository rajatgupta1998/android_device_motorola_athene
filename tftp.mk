...
$(shell ln -s /data/vendor/tombstones/modem $(TARGET_OUT)/rfs/msm/mpss/ramdumps)
...
$(shell ln -s /data/vendor/tombstones/lpass $(TARGET_OUT)/rfs/msm/adsp/ramdumps)
...
$(shell ln -s /data/vendor/tombstones/modem $(TARGET_OUT)/rfs/mdm/mpss/ramdumps)
...
$(shell ln -s /data/vendor/tombstones/lpass $(TARGET_OUT)/rfs/mdm/adsp/ramdumps)
...
$(shell ln -s /data/vendor/tombstones/sparrow $(TARGET_OUT)/rfs/mdm/sparrow/ramdumps)
...
$(shell ln -s /data/vendor/tombstones/modem $(TARGET_OUT)/rfs/apq/gnss/ramdumps)
